...
Vi udvidede vores russisk roulette-funktionalitet til også at
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=8cm]{screenshots/exc8-9/03-caustics_with_all.png}
  \caption{Diffus og spekulær reflektion samt refraktion og lokal belysning}
  \label{fig:8-5-2}
\end{figure}
