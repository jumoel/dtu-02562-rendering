...
forelæsningsslidesne\footnote{Samtidig har vi rettet funktionen, så
...
og kuglen, hvis sammenfaldspunktet endnu var det nærmeste. Disse har
vi efterfølgende skaleret til intervallet $[0;1]$ gemt i den udsendte
stråle.

\section{Del 3}
\label{sec:del-3-2}

Tekstur\emph{lookup} er baseret på de udregninger, der var givet på
...
Ved tilføjelse af tekstur\emph{lookup} i \texttt{shade}-funktionen fik
vi et billede, der kan ses på figur \ref{fig:sphere}. Bemærk, at \emph{ambient}
lys, \emph{lambertian}- og \emph{Phongshading} samt reflektion og
refraktion er fjernet fra raytraceren for bedre at kunne se, om
teksturerne blev indlæst korrekt.
