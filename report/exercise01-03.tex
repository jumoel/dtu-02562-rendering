...
\item Hvis strålen er over en hvis generation (dvs. at der fx fra øjet
...
Et begrænset UML-diagram over den udleverede raytracer kan ses på figur \ref{fig:UML-diagram}.
...
\texttt{k\_diffuse < 1}), udsendes en ekstra stråle, hvis retning
...
\]
%
Strålen får desuden forøget sit niveau med én. Dette bruges til
...
Desværre kan vi ikke beskære objekter til vores \emph{view volume} og
...
implementeret på følgende måde:
...
%
På figur \ref{fig:hardshadow} ses den endelige scene, tilsat skygger.
Skyggerne bliver hårde idet den eneste lyskilde i scenen er et punktlys.
