...
\section{Del 1: UML-diagram}
\label{sec:del-1:-uml}

Et begrænset UML-diagram over den udleverede raytracer kan ses på figur:

\begin{figure}[htbp]
  \centering
  \includegraphics[width=8cm]{screenshots/exc1-3/UML.png}
  \caption{UML-diagram}
  \label{fig:ambient}
\end{figure}

\section{Del 2: Shade-funktionalitet}
...
\section{Del 4: Udvidelse af raytraceren}
